...
c.Authenticator.add_user_cmd =  ['adduser', '-q', '--home', '/home/USERNAME', '--gecos', '""', '--disabled-password']
c.GitHubOAuthenticator.oauth_callback_url = u'https://appsvr.asrc.cestm.albany.edu/hub/oauth_callback'
c.GitHubOAuthenticator.client_id = u'e28b956b838b69ebffcf'
c.GitHubOAuthenticator.client_secret = u'5362c66ccff1766756910fc6c506fba99623458c'
