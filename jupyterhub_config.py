...
c.Spawner.cmd = '/opt/anaconda/anaconda3/envs/jupyterhubEnv/bin/jupyterhub-singleuser'
...
'''
# Spawn user containers from this image
#c.DockerSpawner.container_image = '/srv/jupyterhub/all-spark-notebook'

c.Spawner.cmd = '/srv/jupyterhub/all-spark-notebook'
...
#GITHUB_CLIENT_ID=e28b956b838b69ebffcf
#export GITHUB_CLIENT_SECRET=5362c66ccff1766756910fc6c506fba99623458c
#export OAUTH_CALLBACK_URL=https://appsvr.asrc.cestm.albany.edu/hub/oauth_callback

'''
#from oauthenticator.github import LocalGitHubOAuthenticator
#c.JupyterHub.authenticator_class = LocalGitHubOAuthenticator
#c.LocalGitHubOAuthenticator.create_system_users = True
c.GoogleOAuthenticator.oauth_callback_url = 'https://appsvr.asrc.cestm.albany.edu/hub/oauth_callback'
c.GoogleOAuthenticator.client_id = '920935662481-30782desr309k3oaacniftcsceq07dqg.apps.googleusercontent.com'
c.GoogleOAuthenticator.client_secret = 'L6--68zTb8djGkNNP2cjJ4bn'
'''

#set of users allowed to use the hub
c.Authenticator.whitelist = {'xcite', 'arnold', 'mark', 'mcbdroid', 'wmay'}
...
#c.JupyterHub.data_files_path = '/opt/anaconda/anaconda3/envs/jupyterhubEnv/share/jupyter/hub'
